...
export function ValueHistogramView({ points }: Props) {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ px: 1.2, py: 0.8, borderTop: '1px solid', borderColor: 'divider' }}>
        <Typography variant='caption' color='text.secondary'>
          Occurrence histogram: exact per-value counts. Use the bottom range slider to navigate across all values.
        </Typography>
      </Box>
    </Box>
  );
